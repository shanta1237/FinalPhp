...
<div class="container" style="width: 50%;">
    ...
    <img src="../admin/images/user_default.jpg<?php echo $image; ?>" width="200" style="margin-left: 32%;" class="img-circle" alt="Profile">
    <br><br><br><br>
    <div class="tab">
    ...
    <div id="Edit Details" class="tabcontent">
        ...
        if (isset($_POST['update-user'])) {
            ...
            $query = "UPDATE users SET username='{$username}', user_firstname='{$user_firstname}', user_lastname='{$user_lastname}', user_phoneno={$user_phoneno}, user_email='{$user_email}', user_image='{$image}' WHERE user_id=$curr_user_id";
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <img width="100" src="../admin/images/user_default.jpg<?php echo $user_image ?>">
            </div>
